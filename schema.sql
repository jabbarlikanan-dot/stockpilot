CREATE TABLE IF NOT EXISTS users (id TEXT PRIMARY KEY, username TEXT NOT NULL UNIQUE COLLATE NOCASE, first_name TEXT NOT NULL, last_name TEXT NOT NULL, password_hash TEXT NOT NULL, salt TEXT NOT NULL, password_iterations INTEGER NOT NULL DEFAULT 0, photo_key TEXT, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP);
